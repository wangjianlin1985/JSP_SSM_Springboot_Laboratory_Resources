    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>ResourceType/frontlist">资源类型</a></li>
                <li><a href="<%=basePath %>ResourceInfo/frontlist">资源查询</a></li>
                <!-- 
                <li><a href="<%=basePath %>Borrow/frontlist">借阅</a></li>
                <li><a href="<%=basePath %>Receive/frontlist">领用</a></li> -->
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Borrow/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我借阅的资料</a></li>
                        <li><a href="<%=basePath %>Receive/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我领取的资料</a></li>
